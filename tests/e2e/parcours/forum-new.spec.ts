/**
 * SKI-50 — forum/new (creation post).
 *
 * Le create effectif est skippe (necessite une categorie seed cote back).
 * Ici on valide juste que la page arrive et que le form est rendu.
 */
