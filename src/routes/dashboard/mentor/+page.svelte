<script lang="ts">
	...
	import MentorSlots from '$components/mentors/MentorSlots.svelte';
...
<div class="mx-auto max-w-3xl px-4 py-10 sm:py-14">
	...
	{:else}
		...
		<!-- Availability belongs with the profile, not on the page that sells
		     sessions: publishing a slot only means something once you are the
		     mentor. Below the profile because a slot without a rate and a
		     headline is a slot nobody can book. -->
