...
<div class="animate-[fade-in_300ms_ease-out] text-center">
	{#if status === 'loading'}
		<div
			class="mx-auto mb-4 h-16 w-16 animate-spin rounded-full border-4 border-border border-t-primary"
		></div>
	...
	{:else}
		<div
			class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-error/10 text-error"
		>
