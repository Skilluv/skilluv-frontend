			...
			<div class="p-6">
				...
				{#if user.github || user.linkedin || user.website || user.twitter}
					<div class="mt-4 pt-4 border-t border-border flex flex-wrap gap-4">
						...
						{/if}
						{#if user.twitter}
							<a href="https://x.com/{user.twitter}" target="_blank" rel="external noopener" class="flex items-center gap-1.5 text-xs text-text-muted transition-colors duration-200 hover:text-text-primary">
						...
						{/if}
						{#if user.website}
							<a href={user.website} target="_blank" rel="external noopener" class="flex items-center gap-1.5 text-xs text-text-muted transition-colors duration-200 hover:text-text-primary">
