...
<div class="mx-auto max-w-3xl px-4 py-12 sm:py-16">
	<div class="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
		<div>
			<a
				...
				class="mb-3 inline-block text-sm text-text-muted hover:text-text-primary"
				>← {i18n.t('common.nav.community')}</a
			>
				...
				>
					<div class="flex-1">
						<div class="mb-2 flex items-center gap-2">
							<div
								class="h-4 w-40 rounded bg-surface-overlay animate-[skeleton-pulse_1.5s_ease-in-out_infinite]"
							></div>
							<div
								class="h-5 w-16 rounded-full bg-surface-overlay animate-[skeleton-pulse_1.5s_ease-in-out_infinite]"
							></div>
							<div
								class="h-5 w-14 rounded-full bg-surface-overlay animate-[skeleton-pulse_1.5s_ease-in-out_infinite]"
							></div>
						</div>
						<div
						...
						<div class="mt-2 flex items-center gap-3">
							<div
								class="h-3 w-12 rounded bg-surface-overlay animate-[skeleton-pulse_1.5s_ease-in-out_infinite]"
							></div>
							<div
								class="h-3 w-10 rounded bg-surface-overlay animate-[skeleton-pulse_1.5s_ease-in-out_infinite]"
							></div>
						</div>
					</div>
				</div>
	...
	{:else if challenges.length === 0}
		<div class="py-12 text-center">
			...
			<Button variant="accent" href="/community/challenges/create"
				>{i18n.t('community.mine.createFirst')}</Button
			>
		</div>
	{:else}
