...
export const ar: Translations = {
	...
	events: {
		...
		ended: 'انتهى',
		partner: 'شريك',
		empty: 'لا فعاليات نشطة حالياً. عد قريباً.',
		loadError: 'تعذر تحميل الفعاليات. حاول لاحقاً.',
		joinCta: 'الانضمام إلى الفعالية',
		joinedCta: 'انضممت بالفعل',
		alreadyJoined: 'لقد انضممت إلى هذه الفعالية.',
		backToList: 'العودة إلى الفعاليات',
		myEventsTitle: 'فعالياتي',
		myEventsEmpty: 'لم تنضم إلى أي فعالية بعد.',
		startsOn: 'يبدأ في {date}',
		endsOn: 'ينتهي في {date}',
		stampEarned: 'طابع مُكتسب'
	},
	privacyPage: {
		title: 'الخصوصية والبيانات',
		subtitle: 'تحكم بما نجمعه، بما نرسله، واسترجع بياناتك متى شئت.',
		consents: {
			title: 'الموافقات',
			subtitle: 'قابلة للتغيير في أي وقت. الأساسيات (المصادقة، الأمان، الفوترة) لا تعتمد على هذه الاختيارات.',
			marketingLabel: 'اتصالات تسويقية',
			marketingHint: 'رسائل حول الإطلاقات والتحديثات والعروض. صفر بريد عشوائي تجاري خارجي.',
			analyticsLabel: 'تحليلات المنتج',
			analyticsHint: 'إحصاءات مجهولة لفهم كيفية استخدامك Skilluv وتحسينه.',
			saved: 'تم حفظ الموافقات.'
		},
		gdpr: {
			title: 'تصدير GDPR',
			subtitle: 'ملف يمكن قراءته آلياً لكل بياناتك الشخصية، بالتنسيق القانوني لـ GDPR.',
			requestCta: 'اطلب تصديري',
			pending: 'التصدير قيد التحضير…',
			ready: 'التصدير جاهز.',
			downloadCta: 'تنزيل',
			failed: 'فشل التصدير. اتصل بالدعم.'
		},
		dataExport: {
			title: 'تصدير المنتج',
			subtitle: 'حزمة قابلة للقراءة: محفظتك، التحديات المكتملة، الشارات.',
			requestCta: 'اطلب حزمتي'
		},
		delete: {
			title: 'حذف حسابي',
			subtitle: 'يدخل الحساب في الحذف الناعم لمدة 30 يوماً. بعدها، يُمحى كل شيء نهائياً.',
			requestCta: 'حذف',
			modalTitle: 'تأكيد الحذف',
			modalBody: 'سيُعطّل حسابك فوراً ويُمحى نهائياً بعد 30 يوماً. يمكنك التراجع خلال هذه النافذة بتسجيل الدخول مجدداً.',
			reasonLabel: 'السبب (اختياري)',
			cancelCta: 'إلغاء',
			confirmCta: 'تأكيد الحذف',
			scheduled: 'الحذف مقرر في {date}.'
		}
	},
	seasons: {
		currentLabel: 'الموسم الحالي',
		endsOn: 'ينتهي في {date}',
