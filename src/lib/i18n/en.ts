...
export const en: Translations = {
	...
	board: {
		...
		titleAccent: 'That is the moment to step in.',
		subtitle: 'Progressions, streaks, new ranks: all of it will show up here. Nothing does yet, because nothing has been made yet.',
		emptyTitle: 'Nobody has gone ahead of you.',
		emptyBody: 'The beta opens on 11 January 2027. The first to arrive are not catching up with a leaderboard — they are writing it, and their reviews set the bar for everyone who follows.',
		emptyPoint1: 'A real defect in a real project, not an exercise',
		emptyPoint2: 'A review by a working professional, archived alongside your work',
		emptyPoint3: 'A signed credential any recruiter can verify',
		emptyCta: 'Claim my seat',
		loadError: 'Leaderboard temporarily unavailable.'
	},
	disciplines: {
		sectionEyebrow: 'Eleven disciplines',
		sectionTitle: 'Software is not only code.',
		sectionSubtitle: 'More than a hundred and twenty career tracks, each with the skills it demands. Around thirty are already open; the rest arrive in waves.',
		tracksNote: 'career tracks',
		...
		quality: { label: 'Quality & testing', desc: 'Quality assurance and automation, across all four grounds.' },
	...
	landing: {
		...
		subtitle: 'You learn the craft by shipping on software that genuinely exists, under the eye of working professionals. You walk away with proof of what you built.',
