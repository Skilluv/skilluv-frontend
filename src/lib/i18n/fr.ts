...
export const fr: Translations = {
	common: {
		...
		domains: { code: 'Code', design: 'Design', game: 'Jeux Vidéo', security: 'Cybersécurité', ai: 'Intelligence artificielle', ops: 'Ops & Cloud', soft_skills: 'Communication & leadership' },
