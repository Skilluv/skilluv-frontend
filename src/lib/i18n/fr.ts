...
export const fr: Translations = {
	...
	board: {
		...
		titleAccent: 'C’est le moment d’y entrer.',
		subtitle: 'Progressions, séries, nouveaux rangs : tout ça s’affichera ici. Rien n’y est encore, parce que rien n’a encore été fait.',
		emptyTitle: 'Personne n’est encore passé devant toi.',
		emptyBody: 'La bêta ouvre le 11 janvier 2027. Les premiers arrivés ne rattrapent pas un classement : ils l’écrivent, et ce sont leurs revues qui fixent le niveau attendu pour tous ceux qui suivront.',
		emptyPoint1: 'Un vrai défaut sur un vrai projet, pas un exercice',
		emptyPoint2: 'Une revue par un professionnel en activité, archivée avec ton travail',
		emptyPoint3: 'Une attestation signée, vérifiable par n’importe quel recruteur',
		emptyCta: 'Prendre ma place',
		loadError: 'Classement momentanément indisponible.'
	},
	disciplines: {
		sectionEyebrow: 'Onze disciplines',
		sectionTitle: 'Le logiciel, ce n’est pas que du code.',
		sectionSubtitle: 'Plus de cent vingt parcours métier, chacun avec les compétences qu’il exige. Une trentaine sont déjà ouverts, les autres arrivent par vagues.',
		tracksNote: 'parcours métier',
		...
		quality: { label: 'Qualité & tests', desc: 'Assurance qualité et automatisation, sur les quatre terrains.' },
	...
	landing: {
		...
		subtitle: 'Tu apprends le métier en livrant sur des projets qui existent vraiment, sous l’œil de professionnels en activité. Tu repars avec la preuve de ce que tu as fait.',
