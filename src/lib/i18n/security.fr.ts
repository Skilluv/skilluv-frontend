...
export const securityFr: SecurityTranslations = {
	...
	securityPractice: {
		...
		targetLabel: 'Cible :',
		formatLabel: 'Ici, un flag ressemble à',
		liveNote: 'Mise à jour en direct.',
		labChoosePlaceholder: 'Choisis une réponse',
		labCaseSensitive: 'Comparé tel quel.',
		labPassPercent: '{n}% de bonnes réponses pour valider',
		labMaxAttempts: '{n} tentatives',
		flagCta: 'Soumettre',
		flagCorrect: 'Correct.',
