<script lang="ts">
	...
	let { variant = 'blank', title, body, size = 'md', align = 'center', action }: Props = $props();
		...
		<div class="empty__icon" style:width="{iconSize}px" style:height="{iconSize}px">
			...
			{:else if variant === 'scroll'}
				...
				>
					...
					<path
						d="M 20 30 Q 20 20 30 20 L 70 20 Q 80 20 80 30 Q 80 40 70 40 L 30 40 Q 20 40 20 30 Z"
					/>
			...
			{:else if variant === 'search'}
				...
				>
					<path
						d="M 15 25 L 30 20 L 50 25 L 70 20 L 85 25 L 85 80 L 70 75 L 50 80 L 30 75 L 15 80 Z"
					/>
					<path
						d="M 30 20 L 30 75 M 50 25 L 50 80 M 70 20 L 70 75"
						opacity="0.4"
