<script lang="ts">
	...
	let { challenge, locked = false, loading = false }: Props = $props();
...
{#if loading || !challenge}
	<!-- Skeleton — structure DOM strictement identique au card réel -->
	<div
		class="flex flex-col rounded-2xl border border-border bg-surface-elevated overflow-hidden"
		aria-busy="true"
