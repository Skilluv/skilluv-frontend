...
>
	<div class="flex items-center justify-around py-2">
		{#each [{ href: '/', label: i18n.t('common.nav.home'), icon: 'home' }, { href: '/challenges', label: i18n.t('common.nav.challenges'), icon: 'challenge' }, { href: `/profile/${auth.user?.username}`, label: i18n.t('common.nav.profile'), icon: 'profile' }, { href: '/leaderboards', label: i18n.t('common.nav.leaderboards'), icon: 'leaderboard' }] as item}
